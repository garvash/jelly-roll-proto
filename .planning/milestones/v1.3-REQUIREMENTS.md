# Requirements Archive: v1.3 16x16 Tile Migration
...
- [x] **CONV-01**: CONVERTER-HANDOFF.md documents all schema/grid changes for pml-to-ldtk agent
- [x] **CONV-02**: Handoff includes before/after values for grid_size, room dimensions, entity sizes
- [x] **CONV-03**: Handoff notes any breaking changes to the shared entity-schema contract
...
| CONV-01 | Phase 23 | Complete |
| CONV-02 | Phase 23 | Complete |
