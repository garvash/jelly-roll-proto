...
Use template from `C:/Github/jelly-roll-proto/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Github/jelly-roll-proto/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Github/jelly-roll-proto/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
