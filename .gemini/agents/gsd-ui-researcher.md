...
Use template from `/home/vboxuser/git/jelly-roll-proto/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/vboxuser/git/jelly-roll-proto/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/vboxuser/git/jelly-roll-proto/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
