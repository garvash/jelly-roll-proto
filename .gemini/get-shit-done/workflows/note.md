...
- **Global scope**: `/home/vboxuser/git/jelly-roll-proto/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/vboxuser/git/jelly-roll-proto/.gemini/notes/`)
...
2. Glob `/home/vboxuser/git/jelly-roll-proto/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/vboxuser/git/jelly-roll-proto/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/vboxuser/git/jelly-roll-proto/.gemini/notes/` — works in any directory
