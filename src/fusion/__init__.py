...
Plan 32-02 shipped `protocol`. Plan 04 added FusionManager + ChargeController.
Plan 05 (this Edit) appends DrillDive + Pogo. See PATTERNS § "src/fusion/__init__.py"
for the re-export discipline.
"""
